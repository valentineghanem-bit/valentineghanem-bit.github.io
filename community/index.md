...
<section class="community-v2 v2-scope wrap wrap--wide">
  ...
  <div class="community-layout">
    <aside class="community-sidebar">
      <p class="pull-quote v2-spotlight v2-corner-frame">"Screening services delivered to over 5,000 individuals in underserved populations."</p>
    ...
    <div class="community-main">
      ...
      <div class="event-grid">
        ...
        <article class="event-card v2-spotlight" id="community-event-{{ geo_i }}">
        {%- assign geo_i = geo_i | plus: 1 -%}
          ...
          <div class="event-media event-media--accordion">
            ...
            <figure class="event-media__item{% if p.contain %} event-media__item--contain{% endif %}"{% if p.contain %} style="background-image:url('{{ p.url | relative_url }}');"{% endif %}><img src="{{ p.url | relative_url }}" alt="{{ p.caption }}" loading="lazy">{% if p.caption %}<figcaption class="event-media__caption">{{ p.caption }}</figcaption>{% endif %}</figure>
            {% endfor %}
            {% if e.photos.size > 6 %}
...
<script src="{{ '/assets/js/community-fx.js' | relative_url }}" defer></script>
